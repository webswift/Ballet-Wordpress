...
function envira_standalone_settings_save() {
	...
	if ( !wp_verify_nonce( $_POST['envira-standalone-nonce'], 'envira-standalone-nonce' ) ) {
		add_action( 'envira_gallery_settings_standalone_tab_notice', 'envira_standalone_settings_nonce_notice' );
		return;
	}
	...
	add_action( 'envira_gallery_settings_standalone_tab_notice', 'envira_standalone_settings_saved_notice' );
