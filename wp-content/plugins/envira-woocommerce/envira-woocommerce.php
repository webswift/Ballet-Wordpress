<?php
/**
 * Plugin Name: Envira Gallery - WooCommerce Addon
 * Plugin URI:  http://enviragallery.com
 * Description: Link Envira Gallery images to WooCommerce Products to enable eCommerce functionality from within your Envira Galleries
 * Author:      Envira Gallery Team
 * Author URI:  http://enviragallery.com
 * Version:     1.1.4
 * Text Domain: envira-woocommerce
...
class Envira_WooCommerce {
     ...
     * @var string
     */
    public $plugin_name = 'Envira WooCommerce';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-woocommerce';
     ...
     * @since 1.0.0
     *
     * @return object The Envira_WooCommerce object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_WooCommerce ) ) {
            self::$instance = new Envira_WooCommerce();
        }
...
$envira_woocommerce = Envira_WooCommerce::get_instance();