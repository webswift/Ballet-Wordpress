...
ESSBOptionsStructureHelper::menu_item('import', 'backupimport', __('Import Settings', 'essb'), 'database');
...
//ESSBOptionsStructureHelper::menu_item('advanced', 'twitter', __('Twitter Counter Setup', 'essb'), 'twitter');
//ESSBOptionsStructureHelper::menu_item('advanced', 'convert', __('Import settings from previous version', 'essb'), 'default');
...
ESSBOptionsStructureHelper::field_section_start_panels('advanced', 'optimization', __('CSS Styles Optimizations', 'essb'), __('Activate option that will optimize load of static css resources', 'essb'));
...
ESSBOptionsStructureHelper::field_section_start_panels('advanced', 'optimization', __('Scripts load optimization', 'essb'), __('Activate option that will optimize load of static resources - css and javascript', 'essb'));
...
ESSBOptionsStructureHelper::field_section_start_panels('advanced', 'optimization', __('Global resource load optimizations', 'essb'), __('Activate option that will optimize load of static javascript resources', 'essb'));
...
ESSBOptionsStructureHelper::field_select('advanced', 'optimization', 'essb_cache_mode', __('Cache mode', 'essb'), __('Choose between caching full render of share buttons and resources or cache only dynamic resources (CSS and Javascript).', 'essb'), $cache_mode);
ESSBOptionsStructureHelper::field_switch('advanced', 'optimization', 'essb_cache_static', __('Combine into single file all plugin static CSS files', 'essb'), __('This option will combine all plugin static CSS files into single file.', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
ESSBOptionsStructureHelper::field_switch('advanced', 'optimization', 'essb_cache_static_js', __('Combine into single file all plugin static javascript files', 'essb'), __('This option will combine all plugin static javacsript files into single file. This option will not work if scripts are set to load asynchronous or deferred.', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
...
ESSBOptionsStructureHelper::field_switch('advanced', 'advanced', 'reset_posttype', __('Dublicate check to avoid buttons appear on not associated post types', 'essb'), __('Activate this option if buttons appear on post types that are not marked as active.', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
...
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'advanced_custom_share', __('Activate custom share by social network', 'essb'), __('Activation of this option will add additional menu settings for message share customization by social network.', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
//float_onsingle_only
...
ESSBOptionsStructureHelper::field_section_start('advanced', 'administrative', __('Plugin Settings Access', 'essb'), __('Control access to various plugin settings', 'essb'));
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'disable_adminbar_menu', __('Disable menu in WordPress admin bar', 'essb'), __('Activation of this option will remove the quick access plugin menu from WordPress top admin bar.', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
$listOfOptions = array("manage_options" => "Administrator", "delete_pages" => "Editor", "publish_posts" => "Author", "edit_posts" => "Contributor");
ESSBOptionsStructureHelper::field_select('advanced', 'administrative', 'essb_access', __('Plugin access', 'essb'), __('Make settings available for the following user roles (if you use multiple user roles on your site we recommend to select Administrator to disallow other users change settings of plugin).', 'essb'), $listOfOptions);
ESSBOptionsStructureHelper::field_section_end('advanced', 'administrative');
ESSBOptionsStructureHelper::field_section_start('advanced', 'administrative', __('Metabox visibiltiy', 'essb'), __('Control access to plugin metaboxes', 'essb'));
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'turnoff_essb_advanced_box', __('Remove post advanced visual settings metabox', 'essb'), __('Activation of this option will remove the advanced meta box on each post that allow customizations of visual styles for post.', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'turnoff_essb_optimize_box', __('Remove post share customization metabox', 'essb'), __('Activation of this option will remove the share customization meta box on each post (allows changing social share optimization tags, customize share and etc.).', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'turnoff_essb_stats_box', __('Remove post detailed stats metabox', 'essb'), __('Activation of this option will remove the detailed stats meta box from each post/page when social share analytics option is activated.', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
ESSBOptionsStructureHelper::field_section_end('advanced', 'administrative');
...
ESSBOptionsStructureHelper::field_heading('advanced', 'twitter', 'heading1', __('Twitter Counter Setup', 'essb'));
ESSBOptionsStructureHelper::field_func('advanced', 'twitter', 'essb3_twitter_preload', __('Set initial Twitter share counter value', 'essb'), __('Preload your Twitter share counter with value when self-hosted counter is set to be used. You have also option on each post/page to modify the Twitter share counter value individually.', 'essb'));
...
ESSBOptionsStructureHelper::field_heading('advanced', 'convert', 'heading1', __('Convert and import settings from previous version 2.x/1.x', 'essb'));
ESSBOptionsStructureHelper::field_func('advanced', 'convert', 'essb3_convert_postdata', __('Import settings for', 'essb'), __('Warning! Pressing this button will convert and apply settings from previous versions of product. All your current options will be replaced. Please note that not all options can be automatically imported and applied like Advanced options by post type and button position because of different available settings.', 'essb'));
...
function essb3_options_template_select1() {
	...
	echo do_shortcode('[easy-social-share buttons="facebook,twitter"]');
	echo '
	<input id="essb_style_1" value="1" name="essb_options[style]" type="radio" ' . $n1 . ' />&nbsp;&nbsp;' . __ ( 'Default', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-default.png"/>
	<br/><br/>
	<input id="essb_style_2" value="2" name="essb_options[style]" type="radio" ' . $n2 . ' />&nbsp;&nbsp;' . __ ( 'Metro', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-metro.png"/>
	<br/><br/>
	<input id="essb_style_3" value="3" name="essb_options[style]" type="radio" ' . $n3 . ' />&nbsp;&nbsp;' . __ ( 'Modern', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-modern.png"/>
	<br/><br/>
	...
	<br/><br/>
	<input id="essb_style_5" value="5" name="essb_options[style]" type="radio" ' . $n5 . ' />&nbsp;&nbsp;' . __ ( 'Big', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-big.png"/>
	<br/><br/>
	<input id="essb_style_6" value="6" name="essb_options[style]" type="radio" ' . $n6 . ' />&nbsp;&nbsp;' . __ ( 'Metro (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-metro2.png"/>
	<br/><br/>
	<input id="essb_style_7" value="7" name="essb_options[style]" type="radio" ' . $n7 . ' />&nbsp;&nbsp;' . __ ( 'Big (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-big-retina.png"/>
	<br/><br/>
	<input id="essb_style_8" value="8" name="essb_options[style]" type="radio" ' . $n8 . ' />&nbsp;&nbsp;' . __ ( 'Light (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-light-retina.png"/>
	<br/><br/>
	<input id="essb_style_9" value="9" name="essb_options[style]" type="radio" ' . $n9 . ' />&nbsp;&nbsp;' . __ ( 'Flat (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-flat.png"/>
	<br/><br/>
	<input id="essb_style_10" value="10" name="essb_options[style]" type="radio" ' . $n10 . ' />&nbsp;&nbsp;' . __ ( 'Tiny (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-tiny.png"/>
	<br/><br/>
	<input id="essb_style_11" value="11" name="essb_options[style]" type="radio" ' . $n11 . ' />&nbsp;&nbsp;' . __ ( 'Round (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-round-retina.png"/>
	<br/><br/>
	<input id="essb_style_12" value="12" name="essb_options[style]" type="radio" ' . $n12 . ' />&nbsp;&nbsp;' . __ ( 'Modern (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-modern-retina.png"/>
	<br/><br/>
	<input id="essb_style_13" value="13" name="essb_options[style]" type="radio" ' . $n13 . ' />&nbsp;&nbsp;' . __ ( 'Circles (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-circles-retina.png"/>
	<br/><br/>
	<input id="essb_style_14" value="14" name="essb_options[style]" type="radio" ' . $n14 . ' />&nbsp;&nbsp;' . __ ( 'Blocks (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-blocks-retina.png"/>
	<br/><br/>
	<input id="essb_style_15" value="15" name="essb_options[style]" type="radio" ' . $n15 . ' />&nbsp;&nbsp;' . __ ( 'Dark (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-dark-retina.png"/>
	<br/><br/>
	<input id="essb_style_16" value="16" name="essb_options[style]" type="radio" ' . $n16 . ' />&nbsp;&nbsp;' . __ ( 'Grey Circles (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-grey-circles-retina.png"/>
	<br/><br/>
	<input id="essb_style_17" value="17" name="essb_options[style]" type="radio" ' . $n17 . ' />&nbsp;&nbsp;' . __ ( 'Grey Blocks (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-grey-blocks-retina.png"/>
	<br/><br/>
	<input id="essb_style_18" value="18" name="essb_options[style]" type="radio" ' . $n18 . ' />&nbsp;&nbsp;' . __ ( 'Clear (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-clear-retina.png"/>
	<br/><br/>
	<input id="essb_style_19" value="19" name="essb_options[style]" type="radio" ' . $n19 . ' />&nbsp;&nbsp;' . __ ( 'Copy (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-copy-retina.png"/>
	<br/><br/>
	<input id="essb_style_20" value="20" name="essb_options[style]" type="radio" ' . $n20 . ' />&nbsp;&nbsp;' . __ ( 'Dimmed (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-dimmed-retina.png"/>
	<br/><br/>
	<input id="essb_style_21" value="21" name="essb_options[style]" type="radio" ' . $n21 . ' />&nbsp;&nbsp;' . __ ( 'Grey (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-grey-retina.png"/>
	<br/><br/>
	<input id="essb_style_22" value="22" name="essb_options[style]" type="radio" ' . $n22 . ' />&nbsp;&nbsp;' . __ ( 'Default 3.0 (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-default3-retina.png"/>
	<br/><br/>
	<input id="essb_style_23" value="23" name="essb_options[style]" type="radio" ' . $n23 . ' />&nbsp;&nbsp;' . __ ( 'Jumbo (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-jumbo-retina.png"/>
	<br/><br/>
	<input id="essb_style_24" value="24" name="essb_options[style]" type="radio" ' . $n24 . ' />&nbsp;&nbsp;' . __ ( 'Jumbo Rounded (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-jumbo-rounded-retina.png"/>
	<br/><br/>
	<input id="essb_style_25" value="25" name="essb_options[style]" type="radio" ' . $n25 . ' />&nbsp;&nbsp;' . __ ( 'Fancy (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-fancy-retina.png"/>
	<br/><br/>
	<input id="essb_style_26" value="26" name="essb_options[style]" type="radio" ' . $n26 . ' />&nbsp;&nbsp;' . __ ( 'Deluxe (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-deluxe-retina.png"/>
	<br/><br/>
	<input id="essb_style_27" value="27" name="essb_options[style]" type="radio" ' . $n27 . ' />&nbsp;&nbsp;' . __ ( 'Modern Slim (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-modern-slim-retina.png"/>
	<br/><br/>
	<input id="essb_style_28" value="28" name="essb_options[style]" type="radio" ' . $n28 . ' />&nbsp;&nbsp;' . __ ( 'Bold (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-bold-retina.png"/>
	<br/><br/>
	<input id="essb_style_29" value="29" name="essb_options[style]" type="radio" ' . $n29 . ' />&nbsp;&nbsp;' . __ ( 'Fancy Bold (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-fancy-bold-retina.png"/>
	<br/><br/>
	<input id="essb_style_30" value="30" name="essb_options[style]" type="radio" ' . $n30 . ' />&nbsp;&nbsp;' . __ ( 'Retro (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-retro-retina.png"/>
	<br/><br/>
	<input id="essb_style_31" value="31" name="essb_options[style]" type="radio" ' . $n31 . ' />&nbsp;&nbsp;' . __ ( 'Metro Bold (Retina)', 'essb' ) . '<br /><img src="' . ESSB3_PLUGIN_URL . '/assets/images/demo-style-metro-bold-retina.png"/>
	';
...
function essb3_convert_postdata() {
	echo '<a href="admin.php?page=essb_redirect_advanced&tab=advanced&section=convert&import2x=settings" class="button">'.__('Import plugin settings', 'essb').'</a>';
	echo '<br/><br/><a href="admin.php?page=essb_redirect_advanced&tab=advanced&section=convert&import2x=post" class="button">'.__('Import posts settings', 'essb').'</a>';
	echo '<br/><br/><a href="admin.php?page=essb_redirect_advanced&tab=advanced&section=convert&import2x=fans" class="button">'.__('Import followers counter settings', 'essb').'</a>';
	echo '<br/><br/><a href="admin.php?page=essb_redirect_advanced&tab=advanced&section=convert&import2x=stats" class="button">'.__('Import click log data from previous versions', 'essb').'</a>';
}
...
function essb3_network_selection1() {
