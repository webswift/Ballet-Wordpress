...
function essb_register_settings_metabox_optimize() {
	...
	if (isset($_GET['action'])) {
		...
		if (essb_option_bool_value('pinterest_sniff_disable')) {
			$sidebar_options[] = array(
					'field_id' => 'pinterest',
					'title' => __('Customize Pinterest Image', 'essb'),
					'icon' => 'default',
					'type' => 'menu_item',
					'action' => 'default',
					'default_child' => ''
		...
		$sidebar_options[] = array(
				'field_id' => 'share',
				'title' => __('Customize Share Message (Advanced)', 'essb'),
				'icon' => 'default',
				'type' => 'menu_item',
				'action' => 'default',
				'default_child' => ''
		...
		$sidebar_options[] = array(
				'field_id' => 'ga',
				'title' => __('Customize Google Analytics Campaign Tracking Options', 'essb'),
				'icon' => 'default',
				'type' => 'menu_item',
				'action' => 'default',
				'default_child' => ''
		...
		if (essb_options_bool_value('opengraph_tags') || essb_options_bool_value('twitter_card')) {
			...
			if (essb_options_bool_value('opengraph_tags')) {
				ESSBOptionsFramework::draw_panel_start(__('SOCIAL MEDIA MESSAGE', 'essb'), __('Customize default generate social sharing message that is filled from post data to grab your social media audience', 'essb'), 'fa21 ti-sharethis', '', 'essb_metabox');
				ESSBOptionsFramework::draw_title(__('Social Media Title', 'essb'), __('Add a title that will populate the open graph meta tag which will be used when users share your content onto most social networks. If nothing is provided here, we will use the post title as a backup. <span class="essb-inner-recommend">We recommend usage of titles that does not exceed 60 characters</span>', 'essb'), 'inner-row');
				...
				ESSBOptionsFramework::draw_title(__('Social Media Image', 'essb'), __('Add an image that is optimized for maximum exposure on most social networks.<span class="essb-inner-recommend">We recommend 1200px by 628px</span>', 'essb'), 'inner-row');
				ESSBOptionsFramework::draw_options_row_start_full('inner-row-small');
				ESSBOptionsFramework::draw_fileselect_field('essb_post_og_image', 'essb_metabox', $essb_post_og_image);
				ESSBOptionsFramework::draw_options_row_end();
				...
				ESSBOptionsFramework::draw_options_row_start_full('inner-row-small');
				ESSBOptionsFramework::draw_hint('', __('Did you know that Facebook has share data cache? <br/>All changes that you made on site will not appear immediately unless you clear cache and make Facebook bot revisit your site. The quick way to do this is to use Easy Social Share Buttons top menu in WordPress bar where in Validation you will find link to test and update Facebook information. You can read more about this tool in this article <a href="http://appscreo.com/facebook-debugger-tool/" target="_blank">http://appscreo.com/facebook-debugger-tool/</a> in our blog. ', 'essb'), 'fa32 ti-info-alt');
				ESSBOptionsFramework::draw_options_row_end();
				
				
				ESSBOptionsFramework::draw_heading(__('Additional Facebook Customizations', 'essb'), '5');
				...
				ESSBOptionsFramework::draw_options_row_start_full('inner-row-small');
				ESSBOptionsFramework::draw_input_field('essb_post_og_author_of_post', true, 'essb_metabox', $essb_post_og_author);
				ESSBOptionsFramework::draw_options_row_end();
				
				ESSBOptionsFramework::draw_title(__('Include Video into Social Message', 'essb'), __('Please use the FULL URL to the video (e.g. http://www.yourdomain.com/videos/video.mp4).', 'essb'), 'inner-row');
				ESSBOptionsFramework::draw_options_row_start_full('inner-row-small');
				ESSBOptionsFramework::draw_input_field('essb_post_og_video', true, 'essb_metabox', $essb_post_og_video);
				ESSBOptionsFramework::draw_options_row_end();
		
				ESSBOptionsFramework::draw_options_row_start_full('inner-row-small');
				
				ESSBOptionsFramework::draw_structure_section_start('c5');
				ESSBOptionsFramework::draw_options_row_start(__('Video Width', 'essb'), __('Enter the width of your video. (Example: 320).', 'essb'), '', '8');
				ESSBOptionsFramework::draw_input_field('essb_post_og_video_w', false, 'essb_metabox', $essb_post_og_video_w, '', 'input60');
				ESSBOptionsFramework::draw_options_row_end();
				ESSBOptionsFramework::draw_structure_section_end();
				
				
				ESSBOptionsFramework::draw_structure_section_start('c5');
				ESSBOptionsFramework::draw_options_row_start(__('Video Height', 'essb'), __('Enter the height of your video. (Example: 320).', 'essb'), '', '8');
				ESSBOptionsFramework::draw_input_field('essb_post_og_video_h', false, 'essb_metabox', $essb_post_og_video_h, '', 'input60');
				ESSBOptionsFramework::draw_options_row_end();
				ESSBOptionsFramework::draw_structure_section_end();
		...
		if (essb_option_bool_value('pinterest_sniff_disable')) {
			...
			ESSBOptionsFramework::draw_fileselect_field('essb_post_pin_image', 'essb_metabox', $essb_post_pin_image);
			ESSBOptionsFramework::draw_options_row_end();
			ESSBMetaboxInterface::draw_content_section_end();
		}
