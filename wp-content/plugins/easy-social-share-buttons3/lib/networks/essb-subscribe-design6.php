...
if (!function_exists('essb_subscribe_form_design6')) {
	function essb_subscribe_form_design6($salt, $is_widget = false) {
		global $essb_options;
		...
		$output = '<div class="essb-subscribe-form-content essb-subscribe-from-design6'.($is_widget ? " essb-subscribe-form-inwidget" :"").'">';
