...
if (!function_exists('essb_subscribe_form_design5')) {
	function essb_subscribe_form_design5($salt, $is_widget = false) {
		global $essb_options;
		...
		$input_cols = !$subscribe_mc_namefield ? "essb-subscribe-form-inputwidth1" : "essb-subscribe-form-inputwidth5";
		$submit_width = !$subscribe_mc_namefield ? "essb-subscribe-form-submitwidth1" : "essb-subscribe-form-submitwidth5";
		...
		$output = '<div class="essb-subscribe-form-content essb-subscribe-from-design5'.($is_widget ? " essb-subscribe-form-inwidget" :"").'">';
