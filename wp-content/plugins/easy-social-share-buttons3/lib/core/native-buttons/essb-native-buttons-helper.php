...
class ESSBNativeButtonsHelper {
	...
	public static function draw_single_native_button($network, $settings = array(), $counters = false, $skinned_buttons = false) {
		global $essb_options;
	...
	public static function single_native_button ($network, $settings = array(), $counters = false, $skinned= false) {
		$code = "";

		switch ($network) {
			case "facebook":
				$code = self::facebook_button_code($settings, $counters);
				break;
			case "google":
				$code = self::google_button_code($settings, $counters);
				break;
			case "twitter":
	...
	public static function google_button_code($settings = array(), $counters = false) {
		...
		if ($google_type == "plus") {
			$code = '<div class="g-plusone" data-size="medium" data-href="' . $google_url . '" '.($counters ? '' : 'data-annotation="none"').'></div>';
		}
		else {
			$code .= '<div class="g-follow" data-size="medium" data-href="' . $google_url . '" '.($counters ? '' : 'data-annotation="none"').' data-rel="publisher"></div>';		
		}
