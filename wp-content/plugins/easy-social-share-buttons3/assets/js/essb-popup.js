...
var essb_popup_show = function() {
	...
	jQuery(".essb-popup").css( { width: base_width+'px'});
	jQuery(".essb-popup").center();
	
	jQuery(".essb-popup").fadeIn(400);
	jQuery(".essb-popup-shadow").fadeIn(200);
...
function watchCountdown (periods) { 
    ...
    jQuery('.essb_popup_counter_text').text(user_message + 
        periods[6] + ' sec'); 
}

var essb_popup_close = function() {

	jQuery(".essb-popup").fadeOut(200);
	jQuery(".essb-popup-shadow").fadeOut(400);
}
...
jQuery(document).ready(function($){
	...
	if (popAfter && typeof(popAfter) != "undefined") {
		if (popAfter != '' && Number(popAfter)) {
		    ...
		    $('#essb_settings_popafter_counter').countdown({until: shortly1, onExpiry: essb_popup_show});
