<?php
/**
 * Plugin Name: Envira Gallery - Zoom Addon
 * Plugin URI:  http://enviragallery.com
 * Description: Enables zooming functionality for your Envira Galleries images
 * Author:      David Bisset
 * Author URI:  http://davidbisset.com
 * Version:     1.0.2
 * Text Domain: envira-zoom
...
class Envira_Zoom {
     ...
     * @var string
     */
    public $plugin_name = 'Envira Zoom';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-zoom';
    ...
    public static function get_instance() {
        ...
        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_Zoom ) ) {
            self::$instance = new Envira_Zoom();
        }
...
$envira_zoom = Envira_Zoom::get_instance();