<?php
/**
 * Plugin Name: Envira Gallery - Protection Addon
 * Plugin URI:  http://enviragallery.com
 * Description: Enables image protection (disables right clicking) for Envira galleries.
 * Author:      Envira Gallery Team
 * Author URI:  http://enviragallery.com
 * Version:     1.1.0
 * Text Domain: envira-protection
...
class Envira_Protection {
     ...
     * @var string
     */
    public $plugin_name = 'Envira Protection';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-protection';
...
$envira_protection = Envira_Protection::get_instance();