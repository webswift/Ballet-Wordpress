...
class HFSocialFollowersCounterUpdater {
	
	public function __construct() {
		if (! class_exists ( 'OAuthServer' )) {
			require_once HF_PLUGIN_ROOT . 'lib/core/OAuth/OAuth.php';
		}
	}
	...
	public function update_twitter() {
		...
		$consumer_key = HFSocialFollowersCounterHelper::get_option ( 'twitter_consumer_key' );
		$consumer_secret = HFSocialFollowersCounterHelper::get_option ( 'twitter_consumer_secret' );
		$access_token = HFSocialFollowersCounterHelper::get_option ( 'twitter_access_token' );
		$access_token_secret = HFSocialFollowersCounterHelper::get_option ( 'twitter_access_token_secret' );
		$id = HFSocialFollowersCounterHelper::get_option ( 'twitter_id' );
		...
		if (! class_exists ( 'TwitterOAuth' )) {
			include_once HF_PLUGIN_ROOT . 'lib/core/twitter/twitteroauth.php';
		}
	...
	public function update_facebook() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'facebook_id' );
		$access_token = HFSocialFollowersCounterHelper::get_option ( 'facebook_access_token' );
		$account_type = HFSocialFollowersCounterHelper::get_option ( 'facebook_account_type', 'page' );
	...
	private function update_facebook_page() {
		try {
			$response = $this->remote_update ( 'https://graph.facebook.com/v2.2/' . HFSocialFollowersCounterHelper::get_option ( 'facebook_id' ) . '?fields=likes&&access_token=' . HFSocialFollowersCounterHelper::get_option ( 'facebook_access_token' ) );
			if (isset ( $response ['likes'] )) {
				return $response ['likes'];
			}
		} catch ( Exception $e ) {
	...
	private function update_facebook_followers() {
		...
		try {
			$response = $this->remote_update ( 'https://graph.facebook.com/v2.0/me/subscribers?access_token=' . HFSocialFollowersCounterHelper::get_option ( 'facebook_access_token' ) );
	...
	public function update_googleplus() {
		$api_key = HFSocialFollowersCounterHelper::get_option ( 'google_api_key' );
		if (trim ( $api_key ) == '') {
	...
	public function update_googleplus_api() {
		$id = HFSocialFollowersCounterHelper::get_option ( 'google_id' );
		if (empty ( $id )) {
			return 0;
		}
		$api_key = HFSocialFollowersCounterHelper::get_option ( 'google_api_key' );
		$value_type = HFSocialFollowersCounterHelper::get_option ( 'google_value_type' );
	...
	public function update_pinterest() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'pinterest_id' );
	...
	public function update_linkedin() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'linkedin_id' );
	...
	public function update_github() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'github_id' );
	...
	public function update_vimeo() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'vimeo_id' );
		$account_type = HFSocialFollowersCounterHelper::get_option ( 'vimeo_account_type', 'channel' );
		$access_token = HFSocialFollowersCounterHelper::get_option ( 'vimeo_access_token' );
	...
	private function update_vimeo_channel() {
		...
		try {
			$response = $this->remote_update ( 'http://vimeo.com/api/v2/channel/' . HFSocialFollowersCounterHelper::get_option ( 'vimeo_id' ) . '/info.json' );
	...
	private function update_vimeo_user() {
		...
		try {
			$response = $this->remote_update ( 'https://api.vimeo.com/users/' . HFSocialFollowersCounterHelper::get_option ( 'vimeo_id' ) . '/followers?access_token=' . HFSocialFollowersCounterHelper::get_option ( 'vimeo_access_token' ) );
	...
	public function update_dribbble() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'dribbble_id' );
	...
	public function update_envato() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'envato_id' );
	...
	public function update_soundcloud() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'soundcloud_id' );
		$api_key = HFSocialFollowersCounterHelper::get_option ( 'soundcloud_api_key' );
	...
	public function update_behance() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'behance_id' );
		$api_key = HFSocialFollowersCounterHelper::get_option ( 'behance_api_key' );
	...
	public function update_delicious() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'delicious_id' );
	...
	public function update_instagram() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'instgram_id' );
		$username = HFSocialFollowersCounterHelper::get_option ( 'instgram_username' );
		$api_key = HFSocialFollowersCounterHelper::get_option ( 'instgram_api_key' );
	...
	public function update_youtube() {
		...
		$api_key = HFSocialFollowersCounterHelper::get_option ( 'youtube_api_key' );
		
		if (HFSocialFollowersCounterHelper::get_option ( 'youtube_account_type' ) == 'channel')
			return $this->update_youtube_api3_channel ( $api_key );
		
		if (HFSocialFollowersCounterHelper::get_option ( 'youtube_account_type' ) == 'user')
	...
	public function update_youtube_api3_user($api_key = '') {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'youtube_id' );
	...
	public function update_foursquare() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'foursquare_id' );
		$api_key = HFSocialFollowersCounterHelper::get_option ( 'foursquare_api_key' );
	...
	public function update_forrst() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'forrst_id' );
	...
	public function update_mailchimp() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'mailchimp_list_id' );
		$api_key = HFSocialFollowersCounterHelper::get_option ( 'mailchimp_api_key' );
		...
		if (! class_exists ( 'MCAPI' )) {
			require_once HF_PLUGIN_ROOT . 'lib/core/mailchimp/MCAPI.class.php';
		}
	...
	public function update_vk() {
		$type = HFSocialFollowersCounterHelper::get_option ( 'vk_account_type' );
	...
	public function update_vk_community() {
		$id = HFSocialFollowersCounterHelper::get_option ( 'vk_id' );
	...
	public function update_rss() {
		...
		$account_type = HFSocialFollowersCounterHelper::get_option ( 'rss_account_type', 'manual' );
		$json_file = HFSocialFollowersCounterHelper::get_option ( 'rss_json_file' );
		$url = HFSocialFollowersCounterHelper::get_option ( 'rss_link' );
		$feedblitz = HFSocialFollowersCounterHelper::get_option ( 'rss_feedblitz' );
	...
	private function update_rss_manual() {
		return HFSocialFollowersCounterHelper::get_option ( 'rss_count' );
	}
	
	public function update_vine() {
		
		$email = trim ( HFSocialFollowersCounterHelper::get_option ( 'vine_email' ) );
		$password = trim ( HFSocialFollowersCounterHelper::get_option ( 'vine_password' ) );
		...
		if (! class_exists ( 'VineApp' )) {
			require_once HF_PLUGIN_ROOT . 'lib/core/vine/Vine.php';
		}
	...
	public function update_tumblr() {
		...
		$api_key = trim ( HFSocialFollowersCounterHelper::get_option ( 'tumblr_api_key' ) );
		$api_secret = trim ( HFSocialFollowersCounterHelper::get_option ( 'tumblr_api_secret' ) );
		$access_token = trim ( HFSocialFollowersCounterHelper::get_option ( 'tumblr_access_token' ) );
		$access_token_secret = trim ( HFSocialFollowersCounterHelper::get_option ( 'tumblr_access_token_secret' ) );
		
		$basename = trim ( HFSocialFollowersCounterHelper::get_option ( 'tumblr_basename' ) );
		...
		if (! class_exists ( 'Tumblr' )) {
			require_once HF_PLUGIN_ROOT . 'lib/core/Tumblr/Tumblr.php';
		}
	...
	public function update_slideshare() {
		...
		$username = trim ( HFSocialFollowersCounterHelper::get_option ( 'slideshare_username' ) );
	...
	public function update_c500Px() {
		...
		$api_key = trim ( HFSocialFollowersCounterHelper::get_option ( '500px_api_key' ) );
		$api_secret = trim ( HFSocialFollowersCounterHelper::get_option ( '500px_api_secret' ) );
		$username = trim ( HFSocialFollowersCounterHelper::get_option ( '500px_username' ) );
	...
	public function update_flickr() {
		...
		$api_key = trim ( HFSocialFollowersCounterHelper::get_option ( 'flickr_api_key' ) );
		$username = trim ( HFSocialFollowersCounterHelper::get_option ( 'flickr_id' ) );
	...
	public function update_audioboo() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'audioboo_id' );
	...
	public function update_steamcommunity() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'steamcommunity_id' );
	...
	public function update_weheartit() {
		...
		$id = HFSocialFollowersCounterHelper::get_option ( 'weheartit_id' );
	...
	public function update_feedly() {
		...
		$url = HFSocialFollowersCounterHelper::get_option ( 'feedly_url' );
	...
	public function update_twitch() {
		$id = HFSocialFollowersCounterHelper::get_option ( 'twitch_id' );
		$result = 0;
		try {
			$data = $this->remote_update ( "https://api.twitch.tv/kraken/channels/$id" );
	...
	public function update_spotify() {
		$id = $url = HFSocialFollowersCounterHelper::get_option ( 'spotify_id' );
		$id = rtrim ( $id, "/" );
	...
	public function update_mymail() {
		...
		$list = HFSocialFollowersCounterHelper::get_option ( 'mymail_id' );
	...
	public function update_mailpoet() {
		...
		$list = HFSocialFollowersCounterHelper::get_option ( 'mailpoet_id' );
		
		if (! empty ( $list )) {
			if ($list == 'all') {
				$result = HFSocialFollowersCounterHelper::mailpoet_total_subscribers ();
			} else {
				$result = HFSocialFollowersCounterHelper::mailpoet_get_list_users ( $list );
			}
		}
