<?php
/**
 * Plugin Name: Envira Gallery - Featured Content Addon
...
class Envira_Featured_Content {
     ...
     * @var string
     */
    public $plugin_name = 'Envira Featured Content';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-featured-content';
     ...
     * @since 1.0.0
     *
     * @return object The Envira_Featured_Content object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_Featured_Content ) ) {
            self::$instance = new Envira_Featured_Content();
        }
...
$envira_featured_content = Envira_Featured_Content::get_instance();