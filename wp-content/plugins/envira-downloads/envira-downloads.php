<?php
/**
 * Plugin Name: Envira Gallery - Downloads Addon
 * Plugin URI:  http://enviragallery.com
 * Description: Display Download Icons on Gallery Images
 * Author:      Envira Gallery Team
 * Author URI:  http://enviragallery.com
 * Version:     1.0.6
 * Text Domain: envira-downloads
...
class Envira_Downloads {
     ...
     * @var string
     */
    public $plugin_name = 'Envira Downloads';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-downloads';
    ...
    public function require_global() {
        ...
        require plugin_dir_path( __FILE__ ) . 'includes/global/download.php';
     ...
     * @since 1.0.0
     *
     * @return object The Envira_Downloads object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_Downloads ) ) {
            self::$instance = new Envira_Downloads();
        }
...
$envira_downloads = Envira_Downloads::get_instance();