...
<?php if ($es_desc != "") { ?>
			<div>
				<form class="es_widget_form" style="border: 10px dashed #dd4c39; border-radius: 38px; padding: 16px;">
				<?php if( $es_desc <> "" ) { ?>
					<h4 style="margin-top: 10px; text-align: center; font-size: 30px; line-height: 30px; margin-bottom: 25px;">Travel & Ballet Newsletter</h4>
					<img src="<?php bloginfo('stylesheet_directory'); ?>/framework/img/global/blog_newsletter.jpg"/>
					<div class="es_caption" style="padding-right: 0px; font-size: 15px; line-height: 20px; padding-top: 15px; padding-bottom: 15px;"><?php echo $es_desc; ?></div>
					<?php } ?>
						<div class="es_msg"><span id="es_msg"></span></div>
					<?php if( $es_name == "YES" ) { ?>
						<div class="es_lablebox" style="font-size: 19px; font-weight: bold;"><?php _e('Name', 'email-subscribers'); ?></div>
						<div class="es_textbox">
							<input class="es_textbox_class" name="es_txt_name" id="es_txt_name" value="" maxlength="225" type="text" style="width: 100%;">
					</div>
					<?php } ?>
					<div class="es_lablebox" style="font-size: 19px; font-weight: bold;"><?php _e('Email *', 'email-subscribers'); ?></div>
						<div class="es_textbox">
							<input class="es_textbox_class" name="es_txt_email" id="es_txt_email" onkeypress="if(event.keyCode==13) es_submit_page('<?php echo $url; ?>')" style="width: 100%;" value="" maxlength="225" type="text">
						</div>
					<div class="es_button" style="text-align: center; padding-top: 0px;">
						<input class="es_textbox_button" name="es_txt_button" id="es_txt_button" style="width: 100px; height: 40px; border-radius: 10px; color: white; background-color: #dd4c39; font-size: 18px;
}" onClick="return es_submit_page('<?php echo $url; ?>')" value="<?php _e('Subscribe', 'email-subscribers'); ?>" type="button">
					</div>
					<?php if( $es_name != "YES" ) { ?>
		...
		<?php if ($es_desc == "") { ?>
			<div>
				<form class="es_widget_form" style="border: 10px dashed #dd4c39; border-radius: 38px; padding: 16px;">
					<div class="container" style="width:100%; padin">
						<div class="col-md-6">
							<h4 style="margin-top: 10px; text-align: center; font-size: 30px; line-height: 30px; margin-bottom: 25px;">Travel & Ballet Newsletter</h4>
							<img src="<?php bloginfo('stylesheet_directory'); ?>/framework/img/global/blog_newsletter.jpg"/>
						</div>
						<div class="col-md-6">
							<div class="es_msg"><span id="es_msg"></span></div>
							<div class="es_dess"><p style="font-size:18px; padding-bottom:20px;">Signup today for a unique perspective on travel and ballet from photographer and ballet teacher and be the first to get notified on new updates.</p></div>
							...
							<div class="es_button" style="text-align: center; padding-top: 0px;">
								<input class="es_textbox_button" name="es_txt_button" id="es_txt_button" style="width: 100px; height: 40px; border-radius: 10px; color: white; background-color: #dd4c39; font-size: 18px;}" onClick="return es_submit_page('<?php echo $url; ?>')" value="<?php _e('Subscribe', 'email-subscribers'); ?>" type="button">
							</div>			
						</div>
						<?php if( $es_name != "YES" ) { ?>
							<input name="es_txt_name" id="es_txt_name" value="" type="hidden">
