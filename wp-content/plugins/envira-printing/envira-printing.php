<?php
/**
 * Plugin Name: Envira Gallery - Printing Addon
 * Plugin URI:  http://enviragallery.com
 * Description: Display a Print Icon on Gallery Images
 * Author:      Envira Gallery Team
 * Author URI:  http://enviragallery.com
 * Version:     1.0.2
 * Text Domain: envira-printing
...
class Envira_Printing {
     ...
     * @var string
     */
    public $plugin_name = 'Envira Printing';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-printing';
     ...
     * @since 1.0.0
     *
     * @return object The Envira_Printing object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_Printing ) ) {
            self::$instance = new Envira_Printing();
        }
...
$envira_printing = Envira_Printing::get_instance();