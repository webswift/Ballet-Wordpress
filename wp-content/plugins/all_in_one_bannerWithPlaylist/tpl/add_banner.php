    ...
    <form method="POST" enctype="multipart/form-data" id="form-add-playlist-record">
		<table class="wp-list-table widefat fixed pages" cellspacing="0">
		  <tr>
		    ...
		    <td align="left" valign="middle" width="77%"><a href="?page=all_in_one_bannerWithPlaylist_Manage_Banners" style="padding-left:25%;">Back to Manage Banners</a></td>
		  </tr>
		  <tr>
		    <td width="25%" align="right" valign="middle" class="row-title">Name*</td>
		    <td width="77%" align="left" valign="top"><input name="name" type="text" id="name" size="80" value="<?php echo $_POST['name']?>" /></td>
		  </tr>
		  <tr>
