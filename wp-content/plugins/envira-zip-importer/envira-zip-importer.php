<?php
/**
 * Plugin Name: Envira Gallery - ZIP Importer Addon
...
class Envira_ZIP_Importer {
     ...
     * @var string
     */
    public $plugin_name = 'Envira ZIP Importer';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-zip-importer';
     ...
     * @since 1.0.0
     *
     * @return object The Envira_ZIP_Importer object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_ZIP_Importer ) ) {
            self::$instance = new Envira_ZIP_Importer();
        }
...
$envira_zip_importer = Envira_ZIP_Importer::get_instance();