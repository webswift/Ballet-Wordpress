...
final class FLBuilderBooster {
	...
	public static function init() {
		...
		add_action( 'load-customize.php',                            array( __CLASS__, 'load_customize' ) );
	...
	/**
	 * Load special customizer class
	 *
	 * @action load-customize.php
	 *
	 * @return void
	 */
	public static function load_customize() {

		if ( class_exists( 'FLBuilderBoosterCustomizer' ) ) {

			new FLBuilderBoosterCustomizer;
