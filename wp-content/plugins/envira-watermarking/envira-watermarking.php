<?php
/**
 * Plugin Name: Envira Gallery - Watermarking Addon
 * Plugin URI:  http://enviragallery.com
 * Description: Add a watermark to your Envira Gallery images
 * Author:      Envira Gallery Team
 * Author URI:  http://enviragallery.com
 * Version:     1.1.0
 * Text Domain: envira-watermarking
...
class Envira_Watermarking {
     ...
     * @var string
     */
    public $plugin_name = 'Envira Watermarking';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-watermarking';
     ...
     * @since 1.0.0
     *
     * @return object The Envira_Watermarking object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_Watermarking ) ) {
            self::$instance = new Envira_Watermarking();
        }
...
$envira_watermarking = Envira_Watermarking::get_instance();