	  ...
	  <table class="wp-list-table widefat fixed pages" cellspacing="0">
        ...
        <tr>
		  ...
		  <tr>
		    ...
		    <td align="left" valign="middle"><select name="randomizeImages" id="randomizeImages">
		  ...
		  <tr>
		    ...
		    <td align="left" valign="middle"><select name="skin" id="skin">
		      <option value="classic" <?php echo (($_POST['skin']=='classic')?'selected="selected"':'')?>>classic</option>
		      <option value="universal" <?php echo (($_POST['skin']=='universal')?'selected="selected"':'')?>>universal</option>
		      <option value="attractive" <?php echo (($_POST['skin']=='attractive')?'selected="selected"':'')?>>attractive</option>
            </select></td>
	      </tr>
