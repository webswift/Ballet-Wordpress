<?php
/**
 * Plugin Name: Envira Gallery - Proofing Addon
 * Plugin URI:  http://enviragallery.com
 * Description: Allows clients to login to Galleries and choose photos for ordering.
 * Author:      Envira Gallery Team
 * Author URI:  http://enviragallery.com
 * Version:     1.1.6
 * Text Domain: envira-proofing
...
class Envira_Proofing {
     ...
     * @var string
     */
    public $plugin_name = 'Envira Proofing';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-proofing';
    ...
    public function require_global() {
        ...
        require plugin_dir_path( __FILE__ ) . 'includes/global/order.php';
     ...
     * @since 1.0.0
     *
     * @return object The Envira_Proofing object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_Proofing ) ) {
            self::$instance = new Envira_Proofing();
        }
...
$envira_proofing = Envira_Proofing::get_instance();