<?php
/**
 * Plugin Name: Envira Gallery - Breadcrumbs Addon
 * Plugin URI:  http://enviragallery.com
 * Description: Display Breadcrumb Navigation for Galleries embedded into Albums
 * Author:      Envira Gallery Team
 * Author URI:  http://enviragallery.com
 * Version:     1.0.2
 * Text Domain: envira-breadcrumbs
...
class Envira_Breadcrumbs {
     ...
     * @var string
     */
    public $plugin_name = 'Envira Breadcrumbs';
     ...
     * @var string
     */
    public $plugin_slug = 'envira-breadcrumbs';
    ...
    /**
     * Outputs 'Albums addon required' notice for the addon to work.
     *
     * @since 1.0.0
     */
    function requirements_notice() {
        ...
        ?>
        <div class="error">
            <p><?php printf( __( 'The <strong>%s Addon</strong> requires the Envira Albums addon. Please install and activate the Albums Addon.', 'envira-breadcrumbs' ), $this->plugin_name ); ?></p>
        </div>
        <?php
     ...
     * @since 1.0.0
     *
     * @return object The Envira_Breadcrumbs object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_Breadcrumbs ) ) {
            self::$instance = new Envira_Breadcrumbs();
        }
...
$envira_breadcrumbs = Envira_Breadcrumbs::get_instance();