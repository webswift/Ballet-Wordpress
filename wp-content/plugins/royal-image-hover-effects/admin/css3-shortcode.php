...
function css3_image_hover_effects_style1_shortcode($atts, $content = null){
   ...
   <a href="'.$style1_option['fourth_social_icon_link'].'"><i class="fa '.$style1_option['fourth_social_icon_choser'].' fa-lg"></i></a>
    ...
    <a href="'.$style1_option['fourth_social_icon_link'].'"><i class="fa '.$style1_option['fourth_social_icon_choser'].' fa-lg"></i></a>
		...
		$output .= '
				<h1 style="color: red; ">SORRY THIS EFFECTS ONLY FOR PRO VERSION. IF YOU WANT TO BUY ROYAL IMAGE HOVER EFFECTS PRO VERSION TO GET AWESOME FEATURES PLEASE <a style="color: blue;" target="_blink" href="http://wpmetro.com/downloads/royal-image-hover-effects-wordpress/">CLICK HERE</a></h1>
				';
			}			
		$i++;
	}
